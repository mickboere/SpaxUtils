...
{
	/// <summary>
	/// Courtesy user "reigota": https://answers.unity.com/questions/1736606/animation-state-of-controller-not-showing-in-inspe.html
	/// </summary>
	public class AnimUnhideTool
	{
		...
		private static void Fix()
		{
			...
			{
				throw new UnityException("Select animator controller(s) to fix first.");
			}
