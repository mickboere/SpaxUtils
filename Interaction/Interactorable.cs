...
{
	/// <summary>
	/// Abstract class implementing both <see cref="IInteractable"/> and <see cref="IInteractor"/>.
	/// </summary>
	public abstract class Interactorable : Interactable, IInteractor
	{
		/// <inheritdoc/>
		...
		public Interactorable(IEntity entity, IDependencyManager dependencyManager) : base(entity, dependencyManager)
		{
		}
