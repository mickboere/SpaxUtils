...
namespace SpaxUtils
{
	...
	public class StatConfiguration : IStatConfiguration
	{
		...
		[SerializeField, Conditional(nameof(copyParent), drawToggle: true, hide: false), ConstDropdown(typeof(ILabeledDataIdentifiers), true)] private string parentIdentifier;
